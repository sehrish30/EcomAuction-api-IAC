...
// @ts-ignore
const orderReceiptPDF = awslambda.streamifyResponse(
  async (
...
// export const handler = lambdaFunctionUrlsMiddleware(orderReceiptPDF);
export const handler = orderReceiptPDF;
