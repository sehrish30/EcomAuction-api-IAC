...
var getSignedUrl = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var url, email, bucket, key, expireSeconds, command, err_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                email = ((_a = event.requestContext) === null || _a === void 0 ? void 0 : _a.authorizer).email;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
...
exports.handler = (0, commonMiddleware_1.default)(getSignedUrl);
/**
