...
function processAuctions(event, context) {
    return __awaiter(this, void 0, void 0, function () {
        var auctionsToClose, closePromises, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, (0, getEndedAuctions_1.getEndedAuctions)()];
                case 1:
                    auctionsToClose = _a.sent();
                    closePromises = auctionsToClose === null || auctionsToClose === void 0 ? void 0 : auctionsToClose.map(function (auction) {
                        return (0, closeAuction_1.closeAuction)(auction);
                    });
                    // closedPromises = [ [Object], [Object] ]
                    return [4 /*yield*/, Promise.all(closePromises)];
                case 2:
                    // closedPromises = [ [Object], [Object] ]
                    _a.sent(); // [ Promise { [ [Object], [Object] ] } ]
