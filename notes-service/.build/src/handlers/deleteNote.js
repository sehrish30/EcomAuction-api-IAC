...
var deleteNote = function (event, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var noteId, response, params, command, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4: return [2 /*return*/, {
                    statusCode: 200,
                    body: JSON.stringify({
                        message: "".concat(noteId, " deleted successfully"),
                    }),
                }];
        }
    });
}); };
exports.handler = (0, commonMiddleware_1.default)(deleteNote);
